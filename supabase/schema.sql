...
-- ================================================================
-- Migration 009 — Landing page content settings: walkthrough video +
-- Hotel Thilon map
--
-- Client requirement (landing page redesign to match Figma "Frame 20",
-- 2026-09): the walkthrough-video card and Hotel Thilon location card
-- should be admin-editable rather than hardcoded.
-- ================================================================
