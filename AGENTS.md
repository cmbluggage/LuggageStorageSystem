...
- **Booking edit**: `BookingEditForm` (`src/components/admin/BookingEditForm.tsx`) is shared by both dashboards. See the Business Rules entry above for the re-pricing/payment-status behavior when the schedule changes.
